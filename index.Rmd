...
-  When you view the .pdf output for the overheads, the default is for the table of contents to appear. The fix for this is click the icon in the upper left-hand corner. 
-  The graphical displays upon completion of the tutorial exercises appear only in the narrow window of the code and do not look good. This is a limitation of the *Datacamp* platform. For a more professional looking graph, you can simply copy the code into your own version of `R` to enhance its appearance.
