...
-  For the videos, with this player you hit the **CC** button and then *English* to see close captions. You can also experiment with the speed of the video (the *1x* symbol) and other standard video player features.
...
We retrieved the [Challenge icon](http://www.clipartpanda.com/clipart_images/challenge-stamp-59956608) from [Clipart Panda](http://www.clipartpanda.com/) under a Creative Commons license.
