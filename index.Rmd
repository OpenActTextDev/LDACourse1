...
-  When you view the .pdf output for the overheads, the default is for the table of contents to appear. The fix for this is to click the icon in the upper left-hand corner. 
