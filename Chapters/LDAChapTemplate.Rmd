...
This template illustrates how the pieces of a short course chapter fit together in `R` markdown. It is not stand-alone; it requires .css and javascript files to support it. You can run this within the `R bookdown` course that we have developed; simply call it from the `bookdown.yml` file.
