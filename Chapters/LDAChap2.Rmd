...
####  Video: Estimating a Poisson Frequency Distribution {-}
...
In this assignment, you are asked to fit the negative binomial model to a small set of count data, $\{1,  1,  2,  6,  1,  1,  2,  5, 11\}$.  Because $r$, a parameter of the negative binomial distribution, is a positive real, it is convenient to use the `optimize` function for maximizing the *reduced* likelihood in order to find its *MLE*. It is always advisable to visually confirm the solution by plotting the reduced log-likelihood. 
...
- From the function form, use the closed form expressions for this distribution to check your mean and the variance calculations in the prior step.
::::
...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'Sect23A')">A. Discrete/Finite Mixtures</button>
  <button class="tablinks" onclick="openTab(event, 'Sect23B')">B. Discrete Mixture Probability Mass Function</button>
  <button class="tablinks" onclick="openTab(event, 'Sect23C')">C. Discrete Mixture Example</button>
  <button class="tablinks" onclick="openTab(event, 'Sect23D')">D. Mixture Moments</button>
  <button class="tablinks" onclick="openTab(event, 'Sect23E')">E. Continuous Mixtures</button>
  <button class="tablinks" onclick="openTab(event, 'Sect23F')">F. Continuous Mixtures II</button>
  <button class="tablinks" onclick="openTab(event, 'Sect23G')">G. Review</button>
  </div>

<div id="Sect23A" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=35" width="100%" height="400"> </iframe>
  </div>
<div id="Sect23B" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=36" width="100%" height="400"> </iframe>
  </div>
<div id="Sect23C" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=37" width="100%" height="400"> </iframe>
  </div>
<div id="Sect23D" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=38" width="100%" height="400"> </iframe>
  </div>
<div id="Sect23E" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=39" width="100%" height="400"> </iframe>
  </div>
<div id="Sect23F" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=40" width="100%" height="400"> </iframe>
  </div>
<div id="Sect23G" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap2.pdf#page=41" width="100%" height="400"> </iframe>
  </div>
...
-  Determine the probability mass functions for the low and risk populations for $k=0, \ldots, 20$ possible claim outcomes.
...
<div id="Sect26A" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/Chapter2.7-Shyamal.pdf#page=2" width="100%" height="400"> </iframe>
  </div>
<div id="Sect26B" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/Chapter2.7-Shyamal.pdf#page=3" width="100%" height="400"> </iframe>
  </div>
<div id="Sect26C" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/Chapter2.7-Shyamal.pdf#page=4" width="100%" height="400"> </iframe>
  </div>
<div id="Sect26D" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/Chapter2.7-Shyamal.pdf#page=5" width="100%" height="400"> </iframe>
  </div>
...
The maximum likelihood estimator of $p_0$ is simply the number of zeros divided by the sample size. The *MLE* of $\lambda$ turns out to be the solution of the equation
