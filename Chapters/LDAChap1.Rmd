...
Although not needed to go through the tutorials, some users may wish to download the overheads used in the videos. <button download><a href="https://raw.githubusercontent.com/OpenActTextDev/LDACourse1/main/LDA1.Overheads/LDA1.Chap1.pdf">Download Chapter One overheads as a .pdf file.</a></button>
...
<div class="tab">
<button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceA')">A. Relevance of Insurance</button>
<button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceB')">B. Analytics and Loss Data</button>
<button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceC')">C. What is Analytics?</button>
<button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceD')">D. Insurance Processes</button>  <button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceE')">E. Relevance of Analytics</button>
</div>


<div id="InsuranceRelevanceA" class="tabcontent">
...
ex() %>% check_object("Insample2009", undefined_msg="Use `Insample2009` to create an object named `Insample2009`from the year 2009 data.") %>% check_equal(incorrect_msg="Assign the subset of 2009 data by using subset(Insample, Year==2009), Capitalize Y.")

ex() %>% check_object("Freq2009", undefined_msg="Use `Freq2009` to create an object named `Freq2009`from the year 2009 Claim Frequency data.") %>% check_equal(incorrect_msg="Assign the column Frequency of 2009 data by using Insample2009$Freq in which $ refers the column name")

ex() %>% check_function("length", not_called_msg="Use `length` on the Freq2009 to count the number of entries in the Frequency column") %>% check_result() %>% check_equal(incorrect_msg="Use `Freq2009` to locate the correct column which stores the Frequency data")

ex() %>% check_function("mean", not_called_msg="Use `mean` on the Freq2009 to count the average value of entries in the Frequency column") %>% check_result() %>% check_equal(incorrect_msg="Use `Freq2009` to locate the correct column which stores the Frequency data from Year 2009")

ex() %>% check_function("table", not_called_msg="Use `table` on the Freq2009 to tabulate the frequency data in a tabular form") %>% check_result() %>% check_equal(incorrect_msg="Use `Freq2009` to locate the correct column which stores the Frequency data from Year 2009")
...
ex() %>% check_object("Leng2009", undefined_msg="Use `Leng2009` to create an object named `Leng2009`from the year 2009 Claim Frequency data.") %>% check_equal(incorrect_msg="Assign the Claim Frequency of 2009 data by using Freq2009")

ex() %>% check_function("mean", not_called_msg="Use `mean` on the Freq2009 to count the average value of entries in the Frequency column") %>% check_result() %>% check_equal(incorrect_msg="Use `Freq2009` to locate the correct column which stores the Frequency data from Year 2009")

ex() %>% check_object("Mean2009", undefined_msg="Use `Mean2009` to create an object named `Mean2009`from the year 2009 Claim Frequency data.") %>% check_equal(incorrect_msg="Assign the claim Frequency of 2009 data by using Freq2009")

ex() %>% check_function("table", not_called_msg="Use `table` on the 2009 to tabulate the frequency data in a tabular form") %>% check_result() %>% check_equal(incorrect_msg="Use `Freq2010` to locate the correct column which stores the Frequency data from Year 2009")

ex() %>% check_object("Tab2009", undefined_msg="Use `Tab2009` to create an object named `Tab2009`from the year 2009 Claim Frequency data.") %>% check_equal(incorrect_msg="Assign the Claim Frequency of 2009 data by using Freq2009")
...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityA')">A. Severity Distribution (2010)</button>
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityB')">B. Claims Severity - R Code</button>
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityC')">C. Claim Outcomes and Coverage by Year</button>
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityD')">D. Analysis by Year - R Code</button>
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityE')">E. Claim Frequency and Severity, Deductibles, and Coverage</button>
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityF')">F. Claim Frequency and Severity, Deductibles, and Coverage -
R Code</button>
  <button class="tablinks" onclick="openTab(event, 'PropertyFundSeverityF')">G. Cost of Insurance</button>
      </div>

<div id="PropertyFundSeverityA" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#page=23" width="100%" height="400"> </iframe>
  </div>
<div id="PropertyFundSeverityB" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#page=24" width="100%" height="400"> </iframe>
  </div>
<div id="PropertyFundSeverityC" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#page=25" width="100%" height="400"> </iframe>
  </div>
<div id="PropertyFundSeverityD" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#page=26" width="100%" height="400"> </iframe>
  </div>
<div id="PropertyFundSeverityE" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#page=27" width="100%" height="400"> </iframe>
  </div>
<div id="PropertyFundSeverityF" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#page=28" width="100%" height="400"> </iframe>
  </div>
<div id="PropertyFundSeverityG" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
