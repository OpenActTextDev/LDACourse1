...
#### Overheads: Insurance Relevance (Click Tab to View) {-}

<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceB')">A. Relevance of Insurance</button>
  <button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceC')">B. Analytics and Loss Data Insurance</button>
  <button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceD')">C. What is Analytics?</button>
  <button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceE')">D. Insurance Processes</button>     <button class="tablinks" onclick="openTab(event, 'InsuranceRelevanceA')">E. Relevance of Analytics</button>
  </div>
