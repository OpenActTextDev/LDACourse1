...
<div id="InsCompOperationsA" class="tabcontent">
  ...
  <iframe src="./Overheads/LDA1.Chap1.pdf#InsuranceCompanyOperations" width="100%" height="400"> </iframe>
  </div>
...
<div id="RatingVariablesA" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="./Overheads/LDA1.Chap1.pdf#RatingVariables" width="100%" height="400"> </iframe>
  </div>
...
<div id="RatingVariablesE" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  ![](./Overheads/LDA1.Chap1.pdf#page=32){width="100%" height="400"}
  </div>
