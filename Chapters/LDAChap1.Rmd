...
<div id="InsCompOperationsA" class="tabcontent">
  ...
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=9" width="100%" height="400"> </iframe>
  </div>
<div id="InsCompOperationsB" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=10" width="100%" height="400"> </iframe>
  </div>
<div id="InsCompOperationsC" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=11" width="100%" height="400"> </iframe>
  </div>
<div id="InsCompOperationsD" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=13" width="100%" height="400"> </iframe>
  </div>
...
<div id="RatingVariablesA" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=28" width="100%" height="400"> </iframe>
  </div>
<div id="RatingVariablesB" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=29" width="100%" height="400"> </iframe>
  </div>
<div id="RatingVariablesC" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=30" width="100%" height="400"> </iframe>
  </div>
<div id="RatingVariablesD" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=31" width="100%" height="400"> </iframe>
  </div>
<div id="RatingVariablesE" class="tabcontent">
  <span onclick="this.parentElement.style.display='none'" class="topright">Hide</span>
  <iframe src="https://github.com/OpenActTextDev/LDACourse1/blob/main/Overheads/Chap1Beamer_01Jan2021.pdf#page=32" width="100%" height="400"> </iframe>
  </div>
