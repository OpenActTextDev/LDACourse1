...
The [boxplot()](https://www.rdocumentation.org/packages/graphics/versions/3.6.2/topics/boxplot) function produces box-and-whisker plots of grouped values. The boxplot() function returns certain statistic and produces a plot as a side effect. Explore the   to understand the values returned. In particular review the information returned by the `stats` attribute of this object.
...
For this exercise we calculate 95% confidence intervals for the parameter estimates that we found in Exercise \@ref(Ex:MLEPareto). 
